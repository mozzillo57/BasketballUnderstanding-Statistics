...
def findSVM(im_features, train_labels, kernel):
    ...
    class_weight = {
        #Numero di immagini diviso (classi per immagini di quella classe)
        0: (46 / (4 * 11)),
        1: (46 / (4 * 15)),
        2: (46 / (4 * 10)),
        3: (46 / (4 * 10))
...
def plotConfusions(true, predictions):
    ...
    class_names = ["GSW", "Lakers", "Spurs", "Bucks"]
...
if __name__ == '__main__':
    execute('../dataset/train', '../dataset/train_augmented', 100, 'precomputed')